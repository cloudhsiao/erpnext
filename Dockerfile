...
RUN mkdir -p /home/$FRAPPE_USER/e-invoice

WORKDIR /home/$FRAPPE_USER

COPY setup.sh /
RUN  bash /setup.sh
RUN apt-get -y remove build-essential python-dev python-software-properties libmysqlclient-dev libxslt1-dev libcrypto++-dev \
